...
export function ForTeachersPage() {
  return <Section><PageContainer>
    ...
    <p className="mt-4 text-muted-foreground max-w-3xl">Professional workflows: classes, students, lessons, assignments, quizzes, marking, analytics, AI assistant. Built for Nigerian teachers.</p>
