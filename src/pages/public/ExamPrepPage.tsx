...
export function ExamPrepPage() {
  return <Section><PageContainer>
    ...
    <p className="mt-4 text-muted-foreground max-w-3xl">Support for WAEC, NECO, JAMB, Post-UTME, NABTEB, ICAN, ACCA, CIPM, CIBN. Verified vs AI-generated distinct. No exam PIN marketplace.</p>
