...
export function PricingPage() {
  return <Section><PageContainer>
    ...
    <p className="mt-4 text-muted-foreground max-w-3xl">Free, Premium, Subscription, Credits architecture ready. No fake payments. Paystack/OPay via Laravel API.</p>
