...
export function CareersPage() {
  return <Section><PageContainer>
    <h1 className="text-4xl font-bold">Careers & Scholarships</h1>
    <p className="mt-4 text-muted-foreground max-w-3xl">Discover careers, pathways, skills, scholarships. No fabricated scholarships or partnerships. Saved opportunities.</p>
