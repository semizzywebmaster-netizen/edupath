...
export function ForParentsPage() {
  return <Section><PageContainer>
    <h1 className="text-4xl font-bold">For Parents</h1>
    <p className="mt-4 text-muted-foreground max-w-3xl">Monitor children, progress, activity, goals, reports. Privacy-respecting, permission-aware.</p>
